...
import work_order_dim.Constat.constat;
import work_order_dim.Flinkfcation.HBaseSinkFunction;
import work_order_dim.Flinkfcation.Tablepeocessfcation;
import work_order_dim.Flinkfcation.flinksorceutil;

/**
 * @Package work_order_dim.App_dim
 * @Author chenghang.wang
 * @Date 2025/5/12 14:35
 * @description: chenghang
 */
public class App_dim extends BaseApp{
    public static void main(String[] args) throws Exception{
    new App_dim().start(10001,1,"App_dim", constat.TOPIC_DB);
