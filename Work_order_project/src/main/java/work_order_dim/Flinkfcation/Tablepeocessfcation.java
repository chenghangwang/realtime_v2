package work_order_dim.Flinkfcation;
...
import work_order_dim.TableProcessDim;
...
public class Tablepeocessfcation extends BroadcastProcessFunction<JSONObject, TableProcessDim, Tuple2<JSONObject, TableProcessDim>>{
    ...
    public void open(Configuration parameters) throws Exception {
        Connection mySQLConnection = utils.JdbsUtils.getMySQLConnection();
        List<TableProcessDim> TableProcessDims = utils.JdbsUtils.queryList(mySQLConnection, "select * from realtime.table_process_dim", TableProcessDim.class);
